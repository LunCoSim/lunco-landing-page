...
function gaOptout() {
    ...
    document.cookie = '_ga=; path=/; domain=lunco.space; expires=' + new Date(0).toUTCString();
    document.cookie = '_gid=; path=/; domain=lunco.space; expires=' + new Date(0).toUTCString();
    window[disableStr] = true;
